...
import { default as NavDropdown } from "react-bootstrap/NavDropdown";
import { default as Table } from "react-bootstrap/Table";
          ...
          <Table striped bordered hover responsive variant="dark" className="tTable">
            <thead>
              <tr>
                ...
                <th className="clickable-id" onClick={handleIDClick} width="85">
                  ID
                </th>
                <th width="80">00</th>
                <th width="80">01</th>
