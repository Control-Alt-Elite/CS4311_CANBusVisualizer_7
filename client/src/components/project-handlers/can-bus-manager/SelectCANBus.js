  ...
  return (
    <Form className="can-form" onSubmit={handleSubmit}>
      ...
      <Form.Group as={Row}>
        ...
        <Col sm={2}>
          <Form.Check type="radio" label="125 kbps" name="radios" id="formHorizontalRadios1" value="125000" checked={rate === "125000"} onChange={handleChangeCheck}/>
          <Form.Check type="radio" label="250 kbps" name="radios" id="formHorizontalRadios2" value="250000" checked={rate === "250000"} onChange={handleChangeCheck}/>
          <Form.Check type="radio" label="500 kbps" name="radios" id="formHorizontalRadios3" value="500000" checked={rate === "500000"} onChange={handleChangeCheck}/>
          <Form.Check type="radio" label="1 Mbps" name="radios" id="formHorizontalRadios3" value="1000000" checked={rate === "1000000"} onChange={handleChangeCheck}/>
        </Col>
      </Form.Group>
      <hr />
