...
import { default as CreateProject, default as ProjectInfoHolder } from "../components/project-handlers/project-config/ProjectInfoHolder";
  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route
          exact
          path="/ProjectInfoHolder"
          element={<ProjectInfoHolder />}
        ></Route>
        <Route exact path="/OpenProject" element={<OpenProject />}></Route>
        ...
        <Route
          exact
          path="/TrafficDisplayer"
          element={<TrafficDisplayer />}
        ></Route>
        <Route exact path="/SplitView" element={<SplitView />}></Route>
        <Route exact path="/CANBusManager" element={<CANBusManager />}></Route>
      </Routes>
    </AnimatePresence>
  );
}
